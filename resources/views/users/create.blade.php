...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Create User</h1>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <form method="POST" action="{{ route('users.store') }}" class="form d-flex flex-column flex-lg-row">
            @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <div class="rounded-circle bg-success w-15px h-15px" id="kt_user_status"></div>
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    <!--end::Card header-->
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control mb-2 @error('name') is-invalid @enderror" placeholder="User full name" value="{{ old('name') }}" />
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" name="email" class="form-control mb-2 @error('email') is-invalid @enderror" placeholder="User email address" value="{{ old('email') }}" />
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="password" name="password" class="form-control mb-2 @error('password') is-invalid @enderror" placeholder="User password" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Password must be at least 8 characters long.</div>
                            <!--end::Description-->
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Confirm the user password.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                    </div>
                        ...
                        <div class="fv-row">
                            ...
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" name="roles[]" type="checkbox" value="{{ $role->name }}" id="kt_modal_update_role_option_{{ $loop->index }}" {{ in_array($role->name, old('roles', [])) ? 'checked' : '' }} />
                                    <!--end::Input-->
                                    <!--begin::Label-->
                ...
                <div class="d-flex justify-content-end">
                    <!--begin::Button-->
                    <a href="{{ route('users.index') }}" id="kt_user_cancel" class="btn btn-light me-5">Cancel</a>
                    <!--end::Button-->
                    <!--begin::Button-->
