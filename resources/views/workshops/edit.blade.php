...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Edit Workshop</h1>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form id="kt_workshop_form" class="form d-flex flex-column flex-lg-row" action="{{ route('workshops.update', $workshop) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select status" name="status">
                            ...
                            <option value="published" {{ old('status', $workshop->status) == 'published' ? 'selected' : '' }}>Published</option>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <select class="form-select" data-control="select2" data-placeholder="Select organizers" data-allow-clear="true" multiple="multiple" name="organizer_ids[]">
                            ...
                            <option value="{{ $organizer->id }}" {{ in_array($organizer->id, old('organizer_ids', $workshop->organizers->pluck('id')->toArray())) ? 'selected' : '' }}>{{ $organizer->name }}</option>
                            @endforeach
                        </select>
                        @error('organizer_ids')
                        <div class="text-danger fs-7">{{ $message }}</div>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center">
                                    <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value="{{ $workshop->participants->count() }}">0</div>
                                </div>
                                <div class="fw-semibold fs-6 text-gray-500">Participants</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <div class="d-flex align-items-center">
                                    <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value="{{ $workshop->participants->where('is_checked_in', true)->count() }}">0</div>
                                </div>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="name" class="form-control mb-2" placeholder="Workshop name" value="{{ old('name', $workshop->name) }}" />
                            @error('name')
                            <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10">
                            ...
                            <div id="kt_workshop_description" name="description" class="min-h-200px mb-2">{!! old('description', $workshop->description) !!}</div>
                            <textarea name="description" style="display: none;">{!! old('description', $workshop->description) !!}</textarea>
                            @error('description')
                            <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input class="form-control" placeholder="Pick date & time" name="start_date" id="kt_workshop_start_date" value="{{ old('start_date', $workshop->start_date->format('Y-m-d H:i')) }}" />
                                @error('start_date')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input class="form-control" placeholder="Pick date & time" name="end_date" id="kt_workshop_end_date" value="{{ old('end_date', $workshop->end_date->format('Y-m-d H:i')) }}" />
                                @error('end_date')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="location" class="form-control mb-2" placeholder="Workshop location" value="{{ old('location', $workshop->location) }}" />
                            @error('location')
                            <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="number" name="max_participants" class="form-control mb-2" placeholder="Enter maximum participants" value="{{ old('max_participants', $workshop->max_participants) }}" min="1" />
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('workshops.show', $workshop) }}" id="kt_workshop_cancel" class="btn btn-light me-5">Cancel</a>
