...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Edit Participant</h1>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form id="kt_participant_form" class="form d-flex flex-column flex-lg-row" action="{{ route('participants.update', $participant) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-placeholder="Select workshop" name="workshop_id" id="workshop_select">
                                ...
                                <option value="{{ $workshopOption->id }}" {{ old('workshop_id', $participant->workshop_id) == $workshopOption->id ? 'selected' : '' }}>{{ $workshopOption->name }}</option>
                                @endforeach
                            </select>
                            @error('workshop_id')
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-placeholder="Select ticket type" name="ticket_type_id" id="ticket_type_select">
                                ...
                                <option value="{{ $ticketType->id }}" data-price="{{ $ticketType->price }}" {{ old('ticket_type_id', $participant->ticket_type_id) == $ticketType->id ? 'selected' : '' }}>
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="1" name="is_paid" id="is_paid" {{ old('is_paid', $participant->is_paid) ? 'checked' : '' }} />
                        ...
                        <div class="mb-5">
                            <div class="d-flex align-items-center">
                                <span class="badge badge-light-success me-2">Checked In</span>
                                <span class="text-muted fs-7">{{ $participant->checked_in_at->format('M d, Y H:i') }}</span>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $participant->ticket_code }}" readonly />
                                <button class="btn btn-light-primary" type="button" onclick="copyToClipboard('{{ $participant->ticket_code }}')">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="text-gray-800">{{ $participant->created_at->format('M d, Y H:i') }}</div>
                        </div>
                    </div>
                </div>
                <!--end::Ticket info-->
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card-body pt-0">
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control" placeholder="Enter full name" name="name" value="{{ old('name', $participant->name) }}" />
                                @error('name')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="email" class="form-control" placeholder="Enter email address" name="email" value="{{ old('email', $participant->email) }}" />
                                @error('email')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control" placeholder="Enter phone number" name="phone" value="{{ old('phone', $participant->phone) }}" />
                                @error('phone')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control" placeholder="Enter company name" name="company" value="{{ old('company', $participant->company) }}" />
                                @error('company')
                                <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="position" class="form-control mb-2" placeholder="Enter position or job title" value="{{ old('position', $participant->position) }}" />
                            @error('position')
                            <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-10">
                            ...
                            <textarea name="special_requirements" class="form-control" rows="3" placeholder="Any dietary restrictions, accessibility needs, or other special requirements...">{{ old('special_requirements', $participant->special_requirements) }}</textarea>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('participants.show', $participant) }}" id="kt_participant_cancel" class="btn btn-light me-5">Cancel</a>
...
// Class definition
var KTParticipantEdit = function () {
    // Elements
    var form;
    var submitButton;
    var cancelButton;
    ...
    var handleWorkshopChange = function() {
        ...
        workshopSelect.addEventListener('change', function() {
            ...
            // Clear ticket type options except current selection
            const currentSelection = ticketTypeSelect.value;
                ...
                fetch(`/participants/workshop/${workshopId}/ticket-types`)
                    ...
                    .then(data => {
                        data.forEach(ticketType => {
                            ...
                            if (ticketType.id == currentSelection) {
